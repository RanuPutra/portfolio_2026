...
const documents = "/Users/ranuputra/Documents";
...
test("duplicates into Documents while preserving the source extension", () => {
  assert.equal(
    getDuplicateTextEditPath("/Users/ranuputra/Documents/hello.md", []),
    `${documents}/hello copy.md`
  );
  assert.equal(
    getDuplicateTextEditPath("/Users/ranuputra/Projects/site/README.md", [
